...
public class Barber implements Parcelable {
    private String name, username, password, email, barberId;
    long rating;

    public Barber() {
    }

    public Barber(String name, String username, String password, String email, String barberId, long rating) {
        this.name = name;
